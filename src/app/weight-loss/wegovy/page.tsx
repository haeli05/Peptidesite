          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            <div>
              ...
              <h1 className="text-3xl md:text-5xl font-bold text-[#444444] mb-3 leading-[1.1]" style={{ fontFamily: "var(--font-oswald), sans-serif" }}>
                Wegovy<span className="text-[#FFDD00]">.</span>
              </h1>
              ...
              <p className="text-[#444444]/70 text-base mb-6 leading-relaxed">
                Higher-dose semaglutide specifically approved for chronic weight management. Helps reduce appetite and caloric intake.
              </p>
            ...
            <div className="relative">
              <img
                src="https://cdn.prod.website-files.com/683079b098a24bdd710a41e6/683079b098a24bdd710a457a_Weight-Loss-Banner-03.jpg"
      ...
      <section className="py-16 md:py-24 bg-[#FFFEF0]">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <p className="text-[#444444]/70 text-base leading-relaxed mb-4">
            Wegovy (semaglutide) is an FDA-approved injectable medication specifically designed for chronic weight management. Unlike Ozempic, which was originally developed for diabetes, Wegovy was approved at a higher dose with weight loss as its primary indication.
          </p>
          <p className="text-[#444444]/70 text-base leading-relaxed mb-4">
            As a GLP-1 receptor agonist, Wegovy mimics a naturally occurring hormone that targets areas of the brain involved in appetite regulation. It helps reduce hunger, increase feelings of fullness, and lower overall caloric intake, making it easier to achieve and maintain meaningful weight loss.
          </p>
          <p className="text-[#444444]/70 text-base leading-relaxed">
            Wegovy is administered as a once-weekly subcutaneous injection and is prescribed as part of a comprehensive approach that includes a reduced-calorie diet and increased physical activity. Clinical studies have shown that patients using Wegovy achieved significantly greater weight loss compared to those on placebo.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-[#FFFEF0]">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <p className="text-[#444444]/70 text-base leading-relaxed mb-6">
            Wegovy is designed for adults who meet specific criteria for chronic weight management:
          </p>
          <ul className="space-y-3">
            {[
              "Adults with a BMI of 30 or greater (obesity)",
              "Adults with a BMI of 27 or greater (overweight) who also have at least one weight-related condition such as high blood pressure, type 2 diabetes, or high cholesterol",
              "Individuals seeking an FDA-approved medication specifically indicated for weight management",
              "Those who want a higher-dose semaglutide formulation optimized for weight loss",
              "Patients looking for a once-weekly injectable with strong clinical evidence for chronic weight management",
            ].map((item) => (
            ...
            {[
              {
                ...
                desc: "Tell us about your health history, lifestyle, and weight loss goals through our secure online intake form. A licensed Gold Peptides provider will review your information to determine if Wegovy is right for you.",
              ...
              },
              {
                ...
                desc: "If eligible, your provider will develop a tailored treatment plan with the appropriate Wegovy dosing schedule. Your prescription is customized to your specific health profile and weight management goals.",
              ...
              },
              {
                ...
                desc: "Your approved prescription is filled through our trusted network of licensed pharmacies and delivered straight to your door quickly, securely, and discreetly.",
