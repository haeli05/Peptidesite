    ...
    <main className="flex min-h-screen flex-col">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-xl md:text-2xl text-[#444444]/70 mb-6" style={{ fontFamily: "var(--font-oswald), sans-serif" }}>
                Recharge your cells, restore your energy
              </p>
            ...
            <div className="relative">
              <img
                src="https://cdn.prod.website-files.com/683079b098a24bdd710a41e6/683079b098a24bdd710a45ee_Daily-Health-Feature.jpg"
                alt="NAD+ Injections"
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <p className="text-lg text-[#444444]/70 leading-relaxed">
            NAD+ (Nicotinamide Adenine Dinucleotide) is a coenzyme essential for cellular energy production, DNA repair, and anti-aging. Levels decline with age. Injectable NAD+ delivers directly to cells for maximum bioavailability, bypassing the digestive system to ensure your body gets the full benefit of every dose.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-[#FFFEF0]">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <p className="text-lg text-[#444444]/70 mb-6">
            Adults looking to boost energy, support cellular health, and slow aging. NAD+ may be right for you if you experience:
          </p>
          <ul className="space-y-4">
            {[
              ...
              "Desire to support anti-aging at the cellular level",
              "Interest in optimizing overall wellness and longevity",
            ].map((item, i) => (
      ...
      <section className="py-16 md:py-24 bg-[#333333]">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-white/50 mb-14 max-w-2xl mx-auto">Three simple steps to get started with NAD+ Injections</p>
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              ...
              },
              {
                ...
                desc: "A licensed provider reviews your assessment and prescribes the right NAD+ protocol for you.",
                img: "https://cdn.prod.website-files.com/683079b098a24bdd710a41e6/683079b098a24bdd710a4580_Provider-Writes-an-RX.jpg",
              },
              {
                step: "3",
                title: "Delivered to Your Door",
                desc: "Your NAD+ injections are shipped free and discreetly directly to your home.",
