...
export default function MethyleneBluePage() {
  return (
    <main className="flex min-h-screen flex-col">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-xl md:text-2xl text-[#444444]/70 mb-6" style={{ fontFamily: "var(--font-oswald), sans-serif" }}>
                Enhance cognitive function and cellular energy
              </p>
              <p className="text-[#444444]/60 mb-2 text-sm">
                <span className="font-semibold text-[#444444]">Type:</span> Oral
              </p>
            ...
            <div className="relative">
              <img
                src="https://cdn.prod.website-files.com/683079b098a24bdd710a41e6/683e25c96ba87c932fba510b_colleciton.jpg"
                alt="Methylene Blue"
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <p className="text-lg text-[#444444]/70 leading-relaxed">
            Methylene Blue is a mitochondrial enhancer that supports cognitive function, energy production, and neuroprotection. Originally used as a medical dye, research has revealed its powerful ability to improve mitochondrial efficiency and protect brain cells. Studies suggest benefits for memory, focus, and long-term brain health, making it a compelling option for those looking to optimize mental performance.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-[#FFFEF0]">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-3xl md:text-4xl font-bold text-[#444444] mb-6" style={{ fontFamily: "var(--font-oswald), sans-serif" }}>
            Who is Methylene Blue for?
          </h2>
          <Separator className="mb-8 bg-[#FFDD00] h-1 w-16" />
          <p className="text-lg text-[#444444]/70 mb-6">
            Adults seeking cognitive enhancement and neuroprotective support. Methylene Blue may be right for you if you experience:
          </p>
          <ul className="space-y-4">
            {[
              "Brain fog or difficulty concentrating",
              "Desire to enhance memory and mental clarity",
              "Interest in neuroprotection and long-term brain health",
              "Low mental energy or cognitive fatigue",
              "Looking for mitochondrial support to boost cellular energy",
            ].map((item, i) => (
      ...
      <section className="py-16 md:py-24 bg-[#333333]">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-white/50 mb-14 max-w-2xl mx-auto">Three simple steps to get started with Methylene Blue</p>
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              ...
              },
              {
                ...
                desc: "A licensed provider reviews your assessment and prescribes the right Methylene Blue protocol for you.",
                img: "https://cdn.prod.website-files.com/683079b098a24bdd710a41e6/683079b098a24bdd710a4580_Provider-Writes-an-RX.jpg",
              },
              {
                step: "3",
                title: "Delivered to Your Door",
                desc: "Your Methylene Blue is shipped free and discreetly directly to your home.",
