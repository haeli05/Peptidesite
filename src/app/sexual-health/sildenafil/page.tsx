        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            <div className="relative">
              <img
                src="https://cdn.prod.website-files.com/683079b098a24bdd710a41e6/683079b098a24bdd710a45ed_sexual-banner.jpg"
                alt="Sildenafil - ED Treatment"
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <p className="text-lg text-[#444444]/80 leading-relaxed mb-6">
            Sildenafil is the active ingredient in Viagra. It is a PDE5 inhibitor that increases blood flow for firmer, longer-lasting erections. It typically takes effect in 30-60 minutes and lasts 4-6 hours, giving you reliable performance when you need it.
          </p>
          <p className="text-lg text-[#444444]/80 leading-relaxed">
            As one of the most widely prescribed ED medications in the world, sildenafil has a proven safety profile and decades of clinical evidence supporting its effectiveness. It is available as a convenient oral tablet taken on an as-needed basis.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-[#FFFEF0]">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <p className="text-lg text-[#444444]/80 mb-8">
            Sildenafil is designed for men experiencing erectile dysfunction. It may be right for you if:
          </p>
          <ul className="space-y-4">
            {[
              "You have difficulty achieving or maintaining an erection",
              "You want a proven, FDA-approved ED medication",
              "You prefer an as-needed treatment that works within 30-60 minutes",
              "You want an affordable generic alternative to brand-name Viagra",
              "You are looking for a treatment with a well-established safety record",
            ].map((item, i) => (
