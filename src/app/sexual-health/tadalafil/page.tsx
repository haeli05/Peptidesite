        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            <div className="relative">
              <img
                src="https://cdn.prod.website-files.com/683079b098a24bdd710a41e6/683079b098a24bdd710a45eb_Sexual-Feature.jpg"
                alt="Tadalafil - ED Treatment"
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <p className="text-lg text-[#444444]/80 leading-relaxed mb-6">
            Tadalafil is the active ingredient in Cialis. It is a long-lasting PDE5 inhibitor widely known as &quot;The Weekend Pill&quot; because its effects can last up to 36 hours. This gives you an extended window of opportunity without the need to time your dose precisely.
          </p>
          <p className="text-lg text-[#444444]/80 leading-relaxed">
            Tadalafil can be taken daily at a low dose for around-the-clock readiness, or as needed before sexual activity. This flexibility makes it a popular choice for men who want spontaneity without planning around a pill.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-[#FFFEF0]">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <p className="text-lg text-[#444444]/80 mb-8">
            Tadalafil is designed for men who prefer longer-lasting or daily dosing options. It may be right for you if:
          </p>
          <ul className="space-y-4">
            {[
              "You want an ED medication that lasts up to 36 hours",
              "You prefer the flexibility of daily low-dose or as-needed dosing",
              "You value spontaneity and don't want to time your dose precisely",
              "You want an affordable generic alternative to brand-name Cialis",
              "You are looking for a well-established, FDA-approved treatment",
            ].map((item, i) => (
