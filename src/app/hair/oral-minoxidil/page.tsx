    ...
    <main className="flex min-h-screen flex-col">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-xl md:text-2xl text-[#444444]/70 mb-6" style={{ fontFamily: "var(--font-oswald), sans-serif" }}>
                Stimulate hair growth from the inside out
              </p>
              <p className="text-[#444444]/60 mb-2 text-sm">
                <span className="font-semibold text-[#444444]">Type:</span> Pill, daily
              </p>
            ...
            <div className="relative">
              <img
                src="https://cdn.prod.website-files.com/683079b098a24bdd710a41e6/683079b098a24bdd710a45f1_hair-growth.jpg"
                alt="Oral Minoxidil"
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <p className="text-lg text-[#444444]/70 leading-relaxed">
            Low-dose oral minoxidil increases blood flow to hair follicles, extending the growth phase of the hair cycle. Originally developed as a blood pressure medication, its hair growth benefits were discovered as a side effect. The oral form is more convenient than topical application with systemic benefits, delivering consistent results without the mess of liquids or foams applied to the scalp.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-[#FFFEF0]">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <p className="text-lg text-[#444444]/70 mb-6">
            Men and women looking for a convenient hair growth solution. Oral Minoxidil may be right for you if you are experiencing:
          </p>
          <ul className="space-y-4">
            {[
              "Thinning hair or diffuse hair loss",
              "Frustration with messy topical treatments",
              "Desire for a simple once-daily pill for hair growth",
              "Hair loss that has not responded well to topical minoxidil alone",
              "Looking for a solution that works for both men and women",
            ].map((item, i) => (
      ...
      <section className="py-16 md:py-24 bg-[#333333]">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-white/50 mb-14 max-w-2xl mx-auto">Three simple steps to get started with Oral Minoxidil</p>
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              ...
              },
              {
                ...
                desc: "A licensed provider reviews your assessment and prescribes the right Oral Minoxidil dosage for you.",
                img: "https://cdn.prod.website-files.com/683079b098a24bdd710a41e6/683079b098a24bdd710a4580_Provider-Writes-an-RX.jpg",
              },
              {
                step: "3",
                title: "Delivered to Your Door",
                desc: "Your Oral Minoxidil prescription is shipped free and discreetly directly to your home.",
