    ...
    <main className="flex min-h-screen flex-col">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-xl md:text-2xl text-[#444444]/70 mb-6" style={{ fontFamily: "var(--font-oswald), sans-serif" }}>
                FDA-approved to stop hair loss at the source
              </p>
            ...
            <div className="relative">
              <img
                src="https://cdn.prod.website-files.com/683079b098a24bdd710a41e6/683079b098a24bdd710a45f2_hair-big-banner.jpg"
                alt="Finasteride"
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <p className="text-lg text-[#444444]/70 leading-relaxed">
            Finasteride is an FDA-approved DHT blocker that prevents further hair loss and promotes regrowth. It works by inhibiting the enzyme 5-alpha reductase, which converts testosterone to DHT -- the hormone responsible for shrinking hair follicles. Finasteride reduces DHT levels by up to 70%, and most men see visible results within 3-6 months of consistent use.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-[#FFFEF0]">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <p className="text-lg text-[#444444]/70 mb-6">
            Men experiencing male pattern baldness (androgenetic alopecia). Finasteride may be right for you if you are experiencing:
          </p>
          <ul className="space-y-4">
            {[
              ...
              "Early stages of hair loss where prevention is key",
              "Desire for an FDA-approved, clinically proven solution",
            ].map((item, i) => (
      ...
      <section className="py-16 md:py-24 bg-[#333333]">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-white/50 mb-14 max-w-2xl mx-auto">Three simple steps to get started with Finasteride</p>
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              ...
              },
              {
                ...
                desc: "A licensed provider reviews your assessment and prescribes the right Finasteride dosage for you.",
                img: "https://cdn.prod.website-files.com/683079b098a24bdd710a41e6/683079b098a24bdd710a4580_Provider-Writes-an-RX.jpg",
              },
              {
                step: "3",
                title: "Delivered to Your Door",
                desc: "Your Finasteride prescription is shipped free and discreetly directly to your home.",
